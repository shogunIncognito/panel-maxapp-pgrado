...
export default function PanelLanding (): JSX.Element | null {
  ...
  return (
    <section className='flex flex-col overflow-auto flex-1 w-full bg-slate-400/40 dark:bg-neutral-950/30'>
      <h1 className='lg:text-4xl mx-4 text-2xl text-center mt-5 mb-3 font-bold opacity-80 dark:text-neutral-100 text-black'>Bienvenido al panel de administración de CarSllen</h1>
