      ...
      <div className='grid md:grid-cols-2 md:grid-rows-2 grid-cols-1 grid-rows-3 h-full place-content-center p-4 gap-4 w-full'>
        ...
        <article className={`flex flex-col bg-black/60 rounded h-full justify-center items-center relative`}>
          ...
          <div className='z-10 p-6 bg-black/50 dark:bg-black/75 rounded w-full h-full justify-center items-center flex flex-col'>
            <Link className='rounded text-center transition-all bg-black/50 hover:bg-black/80 ring-2 ring-gray-600 hover:ring-gray-400 duration-300 w-48 py-3 p-2' href='/panel/administrators'>
              Administrar cuentas
            </Link>
          </div>
